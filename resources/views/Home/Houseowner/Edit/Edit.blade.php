...
<body>
    ...
    <h3 class="text-center text-primary rooms-heading">UPDATE YOUR ROOMS</h3>
    ...
    <div class="container">
        <div class="row d-flex justify-content-center">
            <div class="col-sm-10 col-md-5">
                ...
                <form action="{{ url('update/' . $ownerdata->id) }}}" class="room-form" method="POST"
                    enctype="multipart/form-data">

                    @csrf
                    @method('PUT')
                    @if (Session::get('failed'))
                        <h5 class="text-danger text-center">{{ session::get('failed') }}</h5>
                    @endif
                    <div class="form-row">
                        <div class="col">
                            <label for="house-name">House Name</label>
                            <input type="text" class="w-100" id="house-name" name="name" value="{{ $ownerdata->name }}"
                    ...
                    <div class="form-row mt-2">
                        <div class="col">
                            ...
                            <input type="text" class="w-100" id="house-location" name="location"
                                value="{{ $ownerdata->location }}" placeholder="Enter your house Location">
                    ...
                    <div class="form-row">
                        <div class="col">
                            ...
                            <input type="text" class="w-100" id="room-no" name="room" value="{{ $ownerdata->room }}"
                    ...
                    <div class="form-row">
                        <div class="col">
                            ...
                            <input type="text" class="w-100" id="Minimum booking day"
                                value="{{ $ownerdata->min_booking }}" name="minbooking"
                                placeholder="Enter  Minimum booking day">
                    ...
                    <div class="form-row">
                        <div class="col">
                            ...
                            <input type="text" class="w-100" id="Maximum booking day"
                                value="{{ $ownerdata->max_booking }}" name="maxbooking"
                                placeholder="Enter  Maximum booking day">
                    ...
                    <div class="form-row mt-2">
                        <div class="col">
                            ...
                            <select class="custom-select" id="house-floor" name="floor" required>
                                ...
                                <option value="{{ $ownerdata->floor }}">{{ $ownerdata->floor }}</option>
                    ...
                    <div class="form-row mt-2">
                        <div class="col">
                            ...
                            <select class="custom-select" id="bhk" name="bhk" required>
                                <option value="{{ $ownerdata->bhk }}">{{ $ownerdata->bhk }}</option>
                                <option value="1">1</option>
                                <option value="2">2</option>
                                <option value="3">3</option>
                    ...
                    <div class="form-row mt-2">
                        <div class="col">
                            ...
                            <select class="custom-select" id="wifi" name="wifi" required>
                                <option value="{{ $ownerdata->wifi }}">{{ $ownerdata->wifi }}</option>
                    ...
                    <div class="form-row mt-2">
                        <div class="col">
                            ...
                            <select class="custom-select" id="roomsfor" name="roomsfor" required>
                                <option value="{{ $ownerdata->roomsfor }}">{{ $ownerdata->roomsfor }}</option>
                    ...
                    <div class="form-row">
                        <div class="col">
                            ...
                            <input type="text" class="w-100" id="price" name="price" value="{{ $ownerdata->price }}"
                                placeholder="Enter price per day INR">
                    ...
                    <div class="form-check mt-3">
                        <label class="form-check-label">
                            <input type="checkbox" class="form-check-input" value="" required>By click agree our <a
                                href="user-agreement/user-agreement.php" target="_blank">terms</a> and <a
                                href="user-agreement/user-agreement.php" target="_blank">condition.</a>
                        </label>
                    </div>
                    <div class="form-row">
                        <div class="col">
